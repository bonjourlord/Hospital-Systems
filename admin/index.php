                ...
                <tr>
                    <td style="padding:10px" colspan="2">
                        <table border="0" class="profile-container">
                            ...
                            <tr>
                                <td colspan="2">
                                <a href="../logout.php" onclick="if (!confirm('Are you sure you want to logout')) return false"> <input type="button" value="Log out" class="logout-btn btn-primary-soft btn"></a>                                </td>
                            </tr>
                    </table>
                    </td>
                </tr>
